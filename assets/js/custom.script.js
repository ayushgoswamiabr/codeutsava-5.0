            ...
            if (isEmail(emailInput.val())) {
                ...
                $.ajax({
                    ...
                    success: function (ajaxResponse) {
                        ...
                        $('#nit-subalert').addClass("alert alert-success nit-sub-alert").html(ajaxResponse.message);
                    ...
                    error: function (argument) {
                        var ajaxResponse = $.parseJSON(ajaxResponse);
                        $('#nit-subalert').addClass("alert alert-danger nit-sub-alert").html(ajaxResponse.message);
                        // body...
                    }
                });
                $subform[0].reset();
        ...
        $contactForm.validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (ajaxResponse) {
                        try {
                            ...
                            if (ajaxResponse.error) {
                                ...
                                $('.nit-form-msg').removeClass('alert-danger').addClass('alert-success').text(ajaxResponse.message);
                            ...
                            $('.nit-form-msg').removeClass('alert-success').addClass('alert-danger').text('Sorry, we are failed to contact with you. Please reload the page and try again.');
                            $('#nit-form-modal').modal('show');
                            alertInterval = setInterval(function () {
                                $('#nit-form-modal').modal('hide');
                            }, 5000);
                    ...
                    error: function (argument) {
                        $('.nit-form-msg').removeClass('alert-success').addClass('alert-danger').text('Sorry, we can not communicate with you. Please make sure you are connected with internet.');
                        $('#nit-form-modal').modal('show');
                        alertInterval = setInterval(function () {
                            $('#nit-form-modal').modal('hide');
                        }, 5000);
